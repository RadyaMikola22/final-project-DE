...
- Install Docker Compose ~ `sudo apt install docker-compose` for linux or [Install Docker Dekstop for Mac](https://docs.docker.com/desktop/install/mac-install/) or [Install Docker Dekstop for Windows](https://docs.docker.com/desktop/install/windows-install/)
